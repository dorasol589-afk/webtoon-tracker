...
import { updateKakaoTitleStudioNameAction } from "./actions";

export default function KakaoStudioNameEditor({
  contentId,
  studioName,
  readOnly = false,
}: {
  ...
  function handleSave() {
    startTransition(async () => {
      await updateKakaoTitleStudioNameAction(contentId, value.trim());
      setSaved(value.trim());
      setEditing(false);
    });
  }
